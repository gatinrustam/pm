const pointmaticData = {
    rootCdnUrl: 'https://cdn.pointmatic.ru/',
...
// TODO change to constant formInstruction.elements
window.addEventListener('load', () => {
    const {
        backgroundColor,
        backgroundImage,
        backgroundSize
    } = formInstruction.body;

    body.setAttribute('style', `
        background-color: ${backgroundColor};
        background-image: url("${pointmaticData.rootCdnUrl}/${backgroundImage}");
        background-size: ${backgroundSize};
    `)

    formInstruction.elements.map((element) => {
